<template>
  ...
  <div class="col-12 mb-2">
    <cema-input v-model="activityData.extraData.location" component-type="select" required
                :error-data="{required: true, errorStatus: errorSave.location,
                                errorMessage: 'Seleccione una ubicación'}"
                input-title="Ubicación" input-id="location" selected-option="Seleccionar"
                :options="locations" optionKey="name">
