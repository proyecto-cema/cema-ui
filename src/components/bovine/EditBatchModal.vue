      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form @submit.prevent="">
            ...
            <label v-else
              >El lote seleccionado no posee bovinos asignados, para asignarlos diríjase al listado de bovinos.</label
            >
          </form>
        </div>
        <div class="modal-footer">
          <button class="btn btn-dark text-white" data-bs-dismiss="modal" type="button">Cancelar</button>
          <button
