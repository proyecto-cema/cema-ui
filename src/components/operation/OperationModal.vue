      ...
      <div class="modal-content">
          ...
          <form @submit.prevent="">
            <div class="row ms-2 me-2">
              <div class="mb-3 col-12 col-md-6">
                <cema-input v-model.trim="operation.transactionDate" 
                            :error-data="{required: true, errorStatus: errorSave.transactionDate,
                                    errorMessage: 'Ingrese la fecha de la transaccion'}"
                            input-title="Fecha de transaccion" input-id="transactionDate" type="date"></cema-input>
                <div class="mt-4 d-flex justify-content-center">
                  <cema-switch v-model="extraData.isSell" ></cema-switch>
                </div>
              </div>
              <div class="mb-3 col-12 col-md-6">
                    <cema-input v-model.trim="operation.description" maxlength="300" component-type="textarea"
                                input-title="Descripción" input-id="operationDescription" type="text" 
                                rows="4"
                    ></cema-input>
              </div>
              <div v-if="!extraData.isSell" class="mb-3 col-12 col-md-6">
                  <cema-input v-model.trim="operation.buyerName" 
                            :error-data="{required: true, errorStatus: errorSave.sellerBuyerName,
                                    errorMessage: 'Ingrese el nombre del Comprador'}"
                            input-title="Nombre comprador" input-id="operationBuyerName" type="text"></cema-input>
              </div>
              <div v-else class="mb-3 col-12 col-md-6">
                <cema-input v-model.trim="operation.sellerName" 
                            :error-data="{required: true, errorStatus: errorSave.sellerBuyerName,
                                    errorMessage: 'Ingrese el nombre del vendedor'}"
                            input-title="Nombre vendedor" input-id="sellerName" type="text"></cema-input>
              </div>
              <div class="mb-3 col-12 col-md-6">
                <cema-input v-model.trim="operation.amount"
                            :error-data="{required: true, errorStatus: errorSave.amount,
                                    errorMessage: 'Ingrese el monto de la transaccion'}"
                            input-title="Monto" input-id="amount" type="text"></cema-input>
              </div>
              <div class="mb-3 col-12 col-md-6" v-if="extraData.isSell">
                    <tag-search :error-save="errorSave" v-model="operation.bovineTag"/>
              </div>
              <div v-else>
                <div class="mb-3 col-12 col-md-6">
                  <cema-input v-model.trim="operation.bovineTag" maxlength="10" required
              ...
              <div class="col-lg-7 col-12">
                <div class="row">
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model.trim="bovine.tag" maxlength="10" required readonly
                  ...
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model="bovine.taggingDate" :max="getToday" required
                                :error-data="{required: true, errorStatus: errorSaveBovine.taggingDate,
                  ...
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model="bovine.genre" component-type="select" required :disabled="edit"
                                :error-data="{required: true, errorStatus: errorSaveBovine.genre,
                  ...
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model="bovine.category" component-type="select" required
                                :error-data="{required: true, errorStatus: errorSaveBovine.category,
                  ...
                  <div class="col-lg-6 col-12 mb-3" v-if=" bovine.category=='Ternero' || bovine.category=='' ||bovine.category==null">
                   <cema-input v-model="bovine.status" component-type="select" required
                                :error-data="{required: true, errorStatus: errorSaveBovine.status,
        ...
        <div class="modal-footer">
          ...
          <div v-if="extraData.isSell || edit || nextStep">
            <button class="btn btn-secondary text-white" :disabled="!operation.bovineTag" 
              type="button" v-on:click="formSaveOperation()">
              {{ edit ? "Modificar":"Guardar" }}
            </button>
          </div>
          <div v-else>
            <button class="btn btn-secondary text-white" :disabled="!operation.amount" 
              type="button" v-on:click="stepSaveBovine()">
              {{ "Siguiente" }}
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async formSaveOperation() {
      ...
      if (this.errorSave.transactionDate || this.errorSave.amount  ) {
      ...
      if(this.extraData.isSell){
        ...
        this.getBovine(this.operation.bovineTag).then(
          (response) => {
            let bovine={
              edit: true,
              bovine: response
