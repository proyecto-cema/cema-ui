            ...
            <div class="row">
              <div class="col-12">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model="user.establishmentCuig" component-type="select" required
                                :error-data="{required: true, errorStatus: errorSave.establishmentCuig,
                                    errorMessage: 'Ingrese el cuig del establecimiento'}"
                                input-title="CUIG" input-id="establishmentCuig"
                                :options="establishments" optionKey="cuig" v-slot="{ option }">
                      {{ option.name }}{{"   ("+option.cuig+") "}}
                    </cema-input>
                  </div>
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model.trim="user.name" maxlength="50" required
                  ...
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model.trim="user.lastName" required
                  ...
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model.trim="user.email" required
                                input-title="Email" input-id="userEmail" type="email" ></cema-input>
                  </div>
                  <div class="col-lg-6 col-12 mb-3">
                    <cema-input v-model.trim="user.phone" maxlength="15" required
